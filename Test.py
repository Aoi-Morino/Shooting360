...
img_bg = pygame.image.load("Data/img/sky.png")
img_player = pygame.image.load("Data/img/kinoko.png")
img_weapon = pygame.image.load("Data/img/bullet.png")
bg_y = 0
px = 320  # プレイヤーのX座標
py = 240  # プレイヤーのY座標
bx = 0  # 弾のX座標
